...
class cfgFunctions {
  ...
  class s39 {
    ...
    class moduleFunctions {
      ...
      file = "\s39_firefightModules\functions\moduleFunctions";
      class initFirefightPositionModule {};
      class initFirefightCoreModule {};
    };

    class firefightModuleFunctions {
      file = "\s39_firefightModules\functions\firefightModuleFunctions";
      class allowMove {};
    ...
    class guiFunctions {
      file = "\s39_firefightModules\functions\guifunctions";
